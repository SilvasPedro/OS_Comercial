document.addEventListener('DOMContentLoaded', function() {
    const formId = 'osPlanoGamerForm';
    const generateButtonId = 'generateTextPlanoGamer';
    const copyButtonId = 'copyButtonPlanoGamer';
    const resultAreaId = 'resultAreaPlanoGamer';
    const formattedTextId = 'formattedTextPlanoGamer';
    ...
    if (generateTextButton && osForm) {
        generateTextButton.addEventListener('click', function() {
            ...
            // Campos específicos do Plano Gamer
            data.cabeamentoDispositivo = getRadioValue(osForm, 'cabeamentoDispositivo');
            data.quantosQuaisDispositivos = osForm.elements['quantosQuaisDispositivos'].value.trim() || 'Não informado';
...
CABEAMENTO DE DISPOSITIVO: ${data.cabeamentoDispositivo}
QUANTOS E QUAIS: ${data.quantosQuaisDispositivos}
            `.trim();
